...
1. 
- Autocomplete field added

2. 
- Fetched stations and measurements
- Sorted stations by parameter PM2.5
- Choosing only highest measurement from all stations in a city
- Showed 10 highest result by city